...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './channel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANNEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHANNEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHANNEL actions', async () => {
      const expectedActions = [
        {

...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="klassChatApp.userProfile.delete.question">
        <Translate contentKey="klassChatApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>

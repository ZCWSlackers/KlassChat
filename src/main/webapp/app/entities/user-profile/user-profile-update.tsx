  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="klassChatApp.userProfile.home.createOrEditLabel" data-cy="UserProfileCreateUpdateHeading">
            <Translate contentKey="klassChatApp.userProfile.home.createOrEditLabel">Create or edit a UserProfile</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedBlobField
                label={translate('klassChatApp.userProfile.profilePicture')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('klassChatApp.userProfile.user')}
                type="select"
              >
                <option value="" key="0" />
                {users

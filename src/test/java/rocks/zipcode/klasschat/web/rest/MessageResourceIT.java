...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().content(DEFAULT_CONTENT).timestamp(DEFAULT_TIMESTAMP);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().content(UPDATED_CONTENT).timestamp(UPDATED_TIMESTAMP);
        return message;
    }
